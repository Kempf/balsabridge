...
\begin{document}
	...
	\section{Analysis}
		...
		\begin{subequations}
			...
			\label{eqrl}
		\end{subequations}
		The lowest safety ratio member will break first, thus bottom was determined to be the breaking point. The actual maximum load was determined in equation~\ref{eqt}, where $P$ is the load used to calculate $R$. The same steps were carried out in equation~\ref{eqs}, but the strength was assumed to be $1\sigma$ below average.
		\begin{equation}
			\begin{align}
				F&=\frac{R P}{2}
				&=1869.4
